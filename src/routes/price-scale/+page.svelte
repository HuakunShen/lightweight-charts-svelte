...
<div class="container mx-auto px-4 py-8">
	<h1 class="text-3xl font-bold text-gray-800 mb-2">Price Scale Examples</h1>
	...
	<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
		...
		<div class="bg-white rounded-lg shadow p-6">
			<h3 class="text-lg font-semibold text-gray-800 mb-4">Scale Visibility</h3>
			<div class="space-y-3">
				<label class="flex items-center space-x-2">
					...
					>
					<span class="text-gray-700">Left Price Scale (Volume)</span>
				</label>
				<label class="flex items-center space-x-2">
					<input
						type="checkbox"
						...
						class="form-checkbox h-4 w-4 text-blue-600"
					>
					<span class="text-gray-700">Right Price Scale (Price)</span>
				</label>
			</div>
		</div>
	...
	<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
		<!-- Scale Margins -->
		<div class="bg-white rounded-lg shadow p-6">
			<h3 class="text-lg font-semibold text-gray-800 mb-4">Scale Margins</h3>
			<div class="space-y-3">
				<button
					class="w-full bg-indigo-500 hover:bg-indigo-600 text-white text-sm py-2 px-3 rounded transition-colors"
					on:click={() => setScaleMargins(5, 5)}
				>
					5% Margins
				</button>
				<button
					class="w-full bg-indigo-500 hover:bg-indigo-600 text-white text-sm py-2 px-3 rounded transition-colors"
					on:click={() => setScaleMargins(20, 20)}
				>
					20% Margins
				</button>
				<button
					class="w-full bg-indigo-500 hover:bg-indigo-600 text-white text-sm py-2 px-3 rounded transition-colors"
					on:click={() => setScaleMargins(30, 10)}
				>
					30% Top, 10% Bottom
				</button>
			</div>
		...
		<!-- Scale Actions -->
		<div class="bg-white rounded-lg shadow p-6">
			<h3 class="text-lg font-semibold text-gray-800 mb-4">Scale Actions</h3>
			<div class="space-y-3">
				<button
				...
				<button
					class="w-full bg-red-500 hover:bg-red-600 text-white text-sm py-2 px-3 rounded transition-colors"
					on:click={invertScale}
				>
					Invert Scale
				</button>
				<button
	...
	<div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
		<h3 class="font-medium text-blue-800 mb-2">About Price Scales</h3>
