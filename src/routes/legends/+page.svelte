	...
	onMount(() => {
		if (chart && legendElement) {
			...
			chartApi.subscribeCrosshairMove(param => {
				...
				const fibData = param.seriesData.get(chartApi.series()[0]);
				const powData = param.seriesData.get(chartApi.series()[1]);
...
<div class="container mx-auto px-4 py-8">
	<h1 class="text-3xl font-bold text-gray-800 mb-2">Chart Legends Example</h1>
	...
	<div class="grid md:grid-cols-2 gap-6">
		<div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
			<h3 class="font-medium text-blue-800 mb-2">Legend Implementation</h3>
		...
		<div class="bg-green-50 border border-green-200 rounded-lg p-4">
			<h3 class="font-medium text-green-800 mb-2">Features</h3>
